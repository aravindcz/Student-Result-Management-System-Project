...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Civil", "Mechanical", "Electrical", "Electronics", "Computer Science" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String father = (String)jTextField4.getText();
        ...
        try{
            ...
            if(!roll.isEmpty()){
                ...
                st.executeUpdate("insert into students values('"+course+"','"+branch+"','"+roll+"','"+name+"','"+gender+"','"+father+"')");
                JOptionPane.showMessageDialog(null,"Successfully added student details");
                setVisible(false);
                new AdminPanel().setVisible(true);
            }
